        ...
        <div className="pt-32 pb-20 font-sans text-gray-800">
            ...
            <section className="max-w-7xl mx-auto px-6">
                <div className="flex flex-col md:flex-row gap-12 items-start">
                    {/* 画像エリア */}
                    <div className="w-full md:w-1/2 relative aspect-[3/4] overflow-hidden shadow-xl bg-gray-100">
                        <Image
                            src="/is-01.png"
                            alt="代表師範 田坂 貴満"
                            fill
                    ...
                    <div className="w-full md:w-1/2 space-y-10">
                        <div>
                            ...
                            <div className="flex flex-wrap gap-3">
                                <span className="bg-stone-900 text-white px-4 py-1 text-xs font-bold">
                                    実戦空手道 帯会 代表
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="pt-6">
                            <Link
                                href="/contact"
                                className="inline-block bg-emerald-500 text-white px-10 py-4 font-bold shadow-lg hover:bg-emerald-600 transition-all hover:-translate-y-1"
                            >
                                体験・見学を予約する →
                            </Link>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    {[
                        ...
                        <div key={index} className="group cursor-pointer">
                            <div className="relative aspect-[3/4] bg-gray-100 overflow-hidden shadow-md mb-6 transition-all duration-300 group-hover:shadow-xl group-hover:-translate-y-2">
                                <Image
                                    src={instructor.img}
                                    alt={instructor.name}
                                    fill
