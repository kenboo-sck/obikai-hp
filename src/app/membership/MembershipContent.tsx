                ...
                <div className="bg-gradient-to-r from-emerald-400 to-teal-500 py-16 md:py-20 text-white relative flex items-center min-h-[400px]">
                    ...
                    <div className="relative z-10 w-full max-w-7xl mx-auto px-6 text-center md:text-left">
                        ...
                        <div className="text-left">
                            <Link href="/contact" className="inline-block bg-white text-emerald-500 px-10 py-4 font-bold text-lg hover:bg-emerald-50 transition-all rounded-full shadow-lg font-maru">
                                体験予約はこちら
                            </Link>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    ...
                    <div className="bg-gradient-to-r from-emerald-600 to-teal-600 p-8 rounded-xl shadow-lg relative overflow-hidden mb-16 text-white text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-6 hover:shadow-xl transition-shadow">
                        <div>
                            ...
                            <p className="text-teal-100 text-sm font-medium">親子で入会されると、毎月の会費がお得になります。</p>
                        </div>
            ...
            <section className="max-w-7xl mx-auto px-6 mb-24">
                <div className="grid md:grid-cols-2 gap-16">
                    ...
                    <div className="bg-white p-10 shadow-lg border border-gray-100 rounded-xl">
                        <h3 className="text-xl font-bold text-gray-900 mb-8 border-b-2 border-emerald-500 pb-2 inline-block">ご入会時に必要なもの</h3>
                        <ul className="space-y-6 text-gray-700">
                            <li className="flex items-start gap-4">
                                <span className="w-6 h-6 bg-emerald-400 text-white flex items-center justify-center flex-shrink-0 text-xs font-bold rounded-full">1</span>
                                <div>
                            ...
                            <li className="flex items-start gap-4">
                                <span className="w-6 h-6 bg-emerald-400 text-white flex items-center justify-center flex-shrink-0 text-xs font-bold rounded-full">2</span>
                                <div>
                            ...
                            <li className="flex items-start gap-4">
                                <span className="w-6 h-6 bg-emerald-400 text-white flex items-center justify-center flex-shrink-0 text-xs font-bold rounded-full">3</span>
                                <div>
