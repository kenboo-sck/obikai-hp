        ...
        <div className="pt-32 pb-20 font-sans text-gray-800">
            <section className="max-w-4xl mx-auto px-6 mb-16">
                <div className="border-l-8 border-orange-500 pl-6 mb-12">
                    ...
                    <p className="text-orange-500 font-bold mt-2 tracking-widest uppercase text-sm">利用規約</p>
                </div>
                ...
                <div className="bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-10 leading-relaxed">
                    ...
                    <div>
                        ...
                        <ol className="list-decimal list-outside pl-5 text-gray-600 space-y-2 text-sm md:text-base marker:text-orange-400 marker:font-bold">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-gray-900 mb-4 pb-2 border-b border-orange-100 flex items-center gap-2">
                            <span className="w-6 h-6 bg-orange-100 text-orange-600 rounded-full flex items-center justify-center text-xs font-bold">5</span>
                            利用規約の変更
                        </h2>
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-gray-900 mb-4 pb-2 border-b border-orange-100 flex items-center gap-2">
                            <span className="w-6 h-6 bg-orange-100 text-orange-600 rounded-full flex items-center justify-center text-xs font-bold">6</span>
                            準拠法・裁判管轄
                        </h2>
                        <p className="text-gray-600 text-sm md:text-base">
